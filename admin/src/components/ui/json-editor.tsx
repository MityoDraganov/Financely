    ...
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="relative">
        ...
        {!validation.isValid && validation.error && (
          <div className="absolute -bottom-6 left-0 text-xs text-destructive bg-destructive/10 px-2 py-1 rounded">
            {validation.error}
          </div>
        )}
      </div>
      ...
      {validation.isValid && localValue.trim() && (
        <div className="text-xs text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-950/30 px-2 py-1 rounded">
        ...
        >
          ...
          {completion.suggestions.map((suggestion, index) => (
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className={`w-2 h-2 rounded-full ${
                    suggestion.type === 'template' ? 'bg-green-500 dark:bg-green-400' :
                    suggestion.type === 'variable' ? 'bg-primary' :
                    'bg-muted-foreground'
                  }`} />
              ...
              <div className="text-xs font-mono text-foreground mt-1 ml-4 bg-muted px-2 py-1 rounded">
                {suggestion.value}
              </div>
            </div>
          ))}
