 ...
 * 
 * NOTE: This should match the backend admin role system in functions/src/core/admin/admin-roles.ts
 */
...
/**
 * Array of all valid admin role values (for validation)
 */
...
/**
 * Admin role hierarchy levels (higher number = more permissions)
 */
